...
namespace TriadCompiler
    ...
    internal class CodeBuilder
        ...
        /// <summary>
        /// Сгенерировать инициализацию списка
        /// </summary>
        /// <param name="baseTypeString">Базовый тип списка</param>
        /// <returns></returns>
        protected static string GetListFieldInitialization(string baseTypeString)
        {
            return "new List<" + baseTypeString + ">()"; ;
        }
        ...
        public static string GetTypeString( string baseTypeString, ICommonType varType )
            ...
            else if (varType is VarListType)
            {
                resultStringCode = "List<" + baseTypeString + ">";
            }
