...
namespace TriadCompiler
    ...
    public partial class CommonParser
        ...
        /// <summary>
        /// Зарегистрировать функции над списками
        /// </summary>
        private void RegisterListFunctions()
        {
            // ListSize
            FunctionType function = new FunctionType();
            function.Name = "ListSize";
            function.MethodCodeName = "ListFunctions.ListSize";
            VarListType listType = new VarListType(TypeCode.UndefinedType);
            function.AddParameter(listType);
            function.ReturnedType = new VarType(TypeCode.Integer);
            CommonArea.Instance.Register(function);
            ...
            function.MethodCodeName = "ListFunctions.ListAdd";
            function.AddParameter(listType);
            function.AddParameter(new VarType(TypeCode.UndefinedType));
            function.ReturnedType = new VarType(TypeCode.Void);
            CommonArea.Instance.Register(function);

            // ListRemove
            function = new FunctionType();
            function.Name = "ListRemove";
            function.MethodCodeName = "ListFunctions.ListRemove";
            function.AddParameter(listType);
            function.AddParameter(new VarType(TypeCode.UndefinedType));
            function.ReturnedType = new VarType(TypeCode.Void);
            CommonArea.Instance.Register(function);
            ...
            function.MethodCodeName = "ListFunctions.ListInsert";
            function.AddParameter(listType);
            function.AddParameter(new VarType(TypeCode.Integer));
            function.AddParameter(new VarType(TypeCode.UndefinedType));
            function.ReturnedType = new VarType(TypeCode.Void);
            ...
            // ListRemoveAt
            function = new FunctionType();
            function.Name = "ListRemoveAt";
            function.MethodCodeName = "ListFunctions.ListRemoveAt";
            function.AddParameter(listType);
            function.AddParameter(new VarType(TypeCode.Integer));
            function.ReturnedType = new VarType(TypeCode.Void);
            CommonArea.Instance.Register(function);
